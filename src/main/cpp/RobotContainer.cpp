...
RobotContainer::RobotContainer()
  : autoAlign(&drivetrain, &joystick), localization(&drivetrain), gpDetection(&drivetrain), shooter(joystick)
{
...
void RobotContainer::ConfigureBindings()
{
  ...
  frc2::RobotModeTriggers::Disabled().WhileTrue(
      drivetrain.ApplyRequest([] { return swerve::requests::Idle{}; }).IgnoringDisable(true));

  // reset the field-centric heading on left bumper press
  joystick.Start().OnTrue(drivetrain.RunOnce([this] { drivetrain.SeedFieldCentric(); }));
