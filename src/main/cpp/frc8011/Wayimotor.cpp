...
void Wayimotor::Control() {
    ...
    case 1:
        ...
        break;
    case 2:
        wayiconfig.Posoutput = (wayiconfig.targetPosition * wayiconfig.gearRatio + wayiconfig.offset)* 1_tr * wayiconfig.invert;
    ...
    case 3:
        ...
        break;
    case 4:
        wayiconfig.motionoutput = (wayiconfig.targetPosition * wayiconfig.gearRatio + wayiconfig.offset) * 1_tr * wayiconfig.invert;
    ...
    case 5:
        ...
        break;
    case 6:
        wayiconfig.DutyOutput = wayiconfig.targetVelocity / wayiconfig.maxVelocity * 1.0 * wayiconfig.invert; // 将目标速度转换为占空比
...
void Wayimotor::Receive() {
    ...
    // 电机数据接收
    wayiconfig.currentPosition = (motor.GetPosition().GetValueAsDouble() - wayiconfig.offset)/ wayiconfig.gearRatio * wayiconfig.invert;
    ...
    wayiconfig.currentnormalizedPosition = (wayiconfig.currentPosition - wayiconfig.minPosition) / (wayiconfig.maxPosition - wayiconfig.minPosition);
...
void Wayimotor::setNormalizedPosition(double normalizedPos) {
    ...
    setmode(2);
    wayiconfig.targetPosition = wayiconfig.normalizedPosition * (wayiconfig.maxPosition - wayiconfig.minPosition) + wayiconfig.minPosition;
}
