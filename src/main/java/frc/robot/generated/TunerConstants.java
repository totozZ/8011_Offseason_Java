...
// Generated drivetrain file: replace this file as a whole from Tuner X.
// Do not locally reformat or partially copy values into a new generated file.
// 当前参数已按现役底盘核对；更换底盘时必须用 Tuner X 整体替换并重新验证。
...
public class TunerConstants {
        ...
        private static final Slot0Configs driveGains = new Slot0Configs()
                        ...
                        .withKS(0.23).withKV(0.123).withKA(0.1);
        ...
        private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.379150);
