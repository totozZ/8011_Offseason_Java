...
class TunerConstants
{
  ...
  static constexpr configs::Slot0Configs steerGains =
      configs::Slot0Configs{}.WithKP(60).WithKI(0).WithKD(0.5).WithKS(0.1).WithKV(1.5).WithKA(0).WithStaticFeedforwardSign(
  ...
  static constexpr std::string_view kCANBusName = "drive";
...
public:
  ...
  // This needs to be tuned to your individual robot
  static constexpr units::meters_per_second_t kSpeedAt12Volts = 4.93_mps;
...
private:
  ...
  static constexpr int kPigeonId = 33;
...
private:
  ...
  static constexpr units::turn_t kFrontLeftEncoderOffset = -0.2333984375_tr;
  static constexpr bool kFrontLeftSteerMotorInverted = false;
  static constexpr bool kFrontLeftEncoderInverted = false;

  static constexpr units::inch_t kFrontLeftXPos = 11.279527545_in;
  static constexpr units::inch_t kFrontLeftYPos = 10.96456691795_in;

  // Front Right
  static constexpr int kFrontRightDriveMotorId = 4;
  static constexpr int kFrontRightSteerMotorId = 3;
  static constexpr int kFrontRightEncoderId = 5;
  static constexpr units::turn_t kFrontRightEncoderOffset = -0.058837890625_tr;
  static constexpr bool kFrontRightSteerMotorInverted = false;
  static constexpr bool kFrontRightEncoderInverted = false;

  static constexpr units::inch_t kFrontRightXPos = 11.279527545_in;
  static constexpr units::inch_t kFrontRightYPos = -10.96456691795_in;

  // Back Left
  static constexpr int kBackLeftDriveMotorId = 7;
  static constexpr int kBackLeftSteerMotorId = 6;
  static constexpr int kBackLeftEncoderId = 8;
  static constexpr units::turn_t kBackLeftEncoderOffset = -0.273193359375_tr;
  static constexpr bool kBackLeftSteerMotorInverted = false;
  static constexpr bool kBackLeftEncoderInverted = false;

  static constexpr units::inch_t kBackLeftXPos = -11.279527545_in;
  static constexpr units::inch_t kBackLeftYPos = 10.96456691795_in;
  ...
  static constexpr units::turn_t kBackRightEncoderOffset = 0.331298828125_tr;
  static constexpr bool kBackRightSteerMotorInverted = false;
  static constexpr bool kBackRightEncoderInverted = false;

  static constexpr units::inch_t kBackRightXPos = -11.279527545_in;
  static constexpr units::inch_t kBackRightYPos = -10.96456691795_in;

public:
  static constexpr swerve::SwerveModuleConstants FrontLeft =
      ConstantCreator.CreateModuleConstants(kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId,
  ...
  static constexpr swerve::SwerveModuleConstants BackLeft =
      ConstantCreator.CreateModuleConstants(kBackLeftSteerMotorId, kBackLeftDriveMotorId, kBackLeftEncoderId,
  ...
  static constexpr swerve::SwerveModuleConstants BackRight =
      ConstantCreator.CreateModuleConstants(kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId,
