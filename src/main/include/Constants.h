...
namespace TagConstants
{
    ...
    static constexpr std::array<int, 12> ALL_VALID_TAGS = {6, 7, 8, 9, 10, 11, 17, 18, 19, 20, 21, 22}; // 全部有效的 Tag ID
...
namespace LLConstants
{
    ...
    static constexpr frc::Transform2d ROBOT_TO_DETECTION_LL{
        frc::Translation2d{-0.32559_m, 0_m},
