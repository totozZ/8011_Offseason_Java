 ...
 * @brief A header file for the Wayimotor class, which is a class for the motor control of the robot, which includes
 * normal motor parameters and control methods.
 * @version 0.1
 * @date 2025-02-18
 *
 ...
 * @attention
 *
 * if you had modified this file, please make sure your code does not have many bugs, update the version Number, write
 * dowm your name and the date, the most important is make sure the users will have clear and definite understanding
...
private:
  ...
  controls::MotionMagicExpoVoltage mm_position =
      controls::MotionMagicExpoVoltage{ 0_tr }.WithUpdateFreqHz(50_Hz).WithSlot(0).WithEnableFOC(
          1);  // motionmagic控制位置
