...
//                                                                             shoot          IaD  shoot
inline const std::vector<double> slowXLeft={4.40,6.30,7.00,7.80,7.80,5.80,3.20,1.50,1.10,0.50,0.50,3.20,9};
...
inline const std::vector<double> slowSLeft={0   ,2.80,2.00,1.70,1.50,2.30,2.00,0.8 ,2.30,0.90,0.90,2.4 ,2.4 };
...
inline const std::vector<double> AutoXLow={4.40,6.70,8.27,8.27,5.80,3.00,3.00,3.50,5.20,6.10,6.10,7.80,7.80,7.00,6.20,3.20};
inline const std::vector<double> AutoYLow={7.30,7.30,5.90,4.90,5.30,5.30,7.00,7.20,7.40,6.20,3.90,3.90,4.70,6.10,5.30,5.30};
inline const std::vector<double> AutoRLow={0   ,0   ,-90 ,-90 ,132  ,132 ,0   ,  0 ,0   ,-90 ,-90 ,90  ,90  ,130 ,180,130};
inline const std::vector<double> AutoSLow={0   ,2.80,1.70,1.50,2.60,2.00,2.20,2.20,2.40,2.40,2.40,2.40,2.40,2.40,2.40,2.00};
