...
inline const std::vector<double> OutX={3.50,6.00,6.78,7.50,8.25,8.40,8.40,8.00,7.00,6.20,5.70,3.35,3.00,6.00,6.00,5.75,5.70,3.00,1.30,1.10,0.40,1.60,1.66,1.50};
...
//                                                                             shoot          IaD  shoot
inline const std::vector<double> slowXLeft={4.40,5.70,7.00,7.80,7.80,5.80,3.20,1.50,1.10,0.60,0.60,3.20,9};
inline const std::vector<double> slowYLeft={7.30,7.30,7.10,5.90,4.70,5.50,5.50,5.70,7.00,6.90,5.60,5.50,5.50};
inline const std::vector<double> slowRLeft={0   ,0   ,-90 ,-90 ,-90 ,135 ,135 ,135 ,-110,-110,-110,135 ,135   };
inline const std::vector<double> slowSLeft={0   ,2.60,2.60,2.60,2.60,2.30,2.00,0.8 ,2.00,0.90,0.90,2.4 ,2.4 };
...
inline const std::vector<double> AutoXLow={4.40,5.70,7.80,7.80,5.80,3.00,3.00,3.50,5.20,6.10,6.10,7.80,7.80,7.00,5.80,3.20};
inline const std::vector<double> AutoYLow={7.30,7.30,5.90,4.70,5.20,5.80,7.00,7.20,7.40,6.20,4.10,4.10,4.70,6.10,5.50,5.50};
inline const std::vector<double> AutoRLow={0   ,0   ,-90 ,-90 ,135 ,135 ,30  ,  0 ,0   ,-90 ,-90 ,90  ,90  ,130 ,180 ,135};
inline const std::vector<double> AutoSLow={0   ,2.60,2.60,2.60,2.30,2.00,2.20,2.20,2.40,2.40,2.60,2.60,2.60,2.60,2.60,2.00};
...
frc2::CommandPtr ExampleAuto1(CommandSwerveDrivetrain* m_drivetrain, ShooterSubsystem* shooter, 
    FeederSubsystem* feeder, GroundIntakeSubsystem* intake);

frc2::CommandPtr ExampleAutoBlueRight(CommandSwerveDrivetrain* m_drivetrain, ShooterSubsystem* shooter, 
    FeederSubsystem* feeder, GroundIntakeSubsystem* intake, ComplexCommand* complexcommand);
}  // namespace autos
