...
class PassBallCommand: public frc2::CommandHelper<frc2::Command, PassBallCommand> {
 ...
 private:
  ...
  const frc::Translation2d kBlueLeftTarget{units::meter_t{3.0}, units::meter_t{6.0}};
  const frc::Translation2d kBlueRightTarget{units::meter_t{3.0}, units::meter_t{2.0}};
};